setwd("~/C:\Users\Potato\Documents\RFiles")
...
## Generating Plot 1
png(filename="C:\\Users\\Potato\\Documents\\RFiles\\2ndminiproject\\plot1.png")
hist(finalData$Global_active_power, col="red", main="Global Active Power", xlab="Global Active Power (kilowatts)")
dev.off()

## Generating Plot 2
png(filename="C:\\Users\\Potato\\Documents\\RFiles\\2ndminiproject\\plot2.png")
...
png(filename="C:\\Users\\Potato\\Documents\\RFiles\\2ndminiproject\\plot3.png")
...
## Generating Plot 4
png(filename="C:\\Users\\Potato\\Documents\\RFiles\\2ndminiproject\\plot4.png")
labels <- c("Sub_metering_1","Sub_metering_2","Sub_metering_3")
columnlines <- c("black","red","blue")
par(mfrow=c(2,2))
